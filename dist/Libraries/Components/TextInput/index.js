...
var TextInput = (0, _NativeMethodsDecorator2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  function TextInput(props, context) {
    ...
    _this.clear = function () {
      _this.setNativeProps({ text: '' });
    };

    _this.focus = function () {
      _TextInputState2.default.focusTextInput(_reactDom2.default.findDOMNode(_this.refs.input));
    };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _View2.default,
          { className: 'rnw-TextInput-wrapper' },
          _react2.default.createElement(_CoreComponent2.default, _extends({}, props, { style: styles.input, ref: 'input' })),
