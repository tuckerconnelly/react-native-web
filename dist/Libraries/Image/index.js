    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _View2.default,
        {
          ...
          className: (0, _classnames2.default)('rnw-Image-initial', className),
          style: [backgroundImage && { backgroundImage: backgroundImage }, resizeModeStyles[resizeMode], style],
          testID: testID
        },
        _react2.default.createElement('img', { className: 'rnw-Image', src: displayImage, role: 'presentation' }),
