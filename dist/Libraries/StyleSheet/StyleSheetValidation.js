...
var _ReactPropTypesSecret = require('react/lib/ReactPropTypesSecret');
  ...
  _createClass(StyleSheetValidation, null, [{
    ...
    value: function validateStyleProp(prop, style, caller) {
      if (process.env.NODE_ENV !== 'production') {
        ...
        var error = allStylePropTypes[prop](style, prop, caller, _ReactPropTypeLocations2.default.prop, null, _ReactPropTypesSecret2.default);
        if (error) {
